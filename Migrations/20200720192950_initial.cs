        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlunoDisciplinaAlunoId = table.Column<int>(nullable: true),
                    AlunoDisciplinaDisciplinaId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AlunosDisciplinas_AlunosDisciplinas_AlunoDisciplinaAlunoId_AlunoDisciplinaDisciplinaId",
                        columns: x => new { x.AlunoDisciplinaAlunoId, x.AlunoDisciplinaDisciplinaId },
                        principalTable: "AlunosDisciplinas",
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "AlunoId", "DisciplinaId", "AlunoDisciplinaAlunoId", "AlunoDisciplinaDisciplinaId" },
            ...
            migrationBuilder.InsertData(
                table: "AlunosDisciplinas",
                columns: new[] { "AlunoId", "DisciplinaId", "AlunoDisciplinaAlunoId", "AlunoDisciplinaDisciplinaId" },
                values: new object[] { 7, 4, null, null });

            migrationBuilder.InsertData(
                table: "AlunosDisciplinas",
                columns: new[] { "AlunoId", "DisciplinaId", "AlunoDisciplinaAlunoId", "AlunoDisciplinaDisciplinaId" },
                values: new object[] { 6, 4, null, null });
            ...
            migrationBuilder.InsertData(
                table: "AlunosDisciplinas",
                columns: new[] { "AlunoId", "DisciplinaId", "AlunoDisciplinaAlunoId", "AlunoDisciplinaDisciplinaId" },
                values: new object[] { 7, 3, null, null });
            ...
            migrationBuilder.InsertData(
                table: "AlunosDisciplinas",
                columns: new[] { "AlunoId", "DisciplinaId", "AlunoDisciplinaAlunoId", "AlunoDisciplinaDisciplinaId" },
                values: new object[] { 6, 3, null, null });
            ...
            migrationBuilder.InsertData(
                table: "AlunosDisciplinas",
                columns: new[] { "AlunoId", "DisciplinaId", "AlunoDisciplinaAlunoId", "AlunoDisciplinaDisciplinaId" },
                values: new object[] { 6, 2, null, null });

            migrationBuilder.InsertData(
                table: "AlunosDisciplinas",
                columns: new[] { "AlunoId", "DisciplinaId", "AlunoDisciplinaAlunoId", "AlunoDisciplinaDisciplinaId" },
                values: new object[] { 3, 2, null, null });
            ...
            migrationBuilder.InsertData(
                table: "AlunosDisciplinas",
                columns: new[] { "AlunoId", "DisciplinaId", "AlunoDisciplinaAlunoId", "AlunoDisciplinaDisciplinaId" },
                values: new object[] { 7, 1, null, null });
            ...
            migrationBuilder.InsertData(
                table: "AlunosDisciplinas",
                columns: new[] { "AlunoId", "DisciplinaId", "AlunoDisciplinaAlunoId", "AlunoDisciplinaDisciplinaId" },
                values: new object[] { 7, 5, null, null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AlunosDisciplinas_AlunoDisciplinaAlunoId_AlunoDisciplinaDisciplinaId",
                table: "AlunosDisciplinas",
